...
<div id="list-task" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="costEstimated"
                              title="${message(code: 'task.costEstimated.label', default: 'Cost Estimated')}"/>
        ...
        <g:each in="${taskInstanceList}" status="i" var="taskInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td>${fieldValue(bean: taskInstance, field: "costEstimated")}</td>
