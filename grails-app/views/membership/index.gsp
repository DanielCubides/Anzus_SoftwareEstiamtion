		...
		<div id="list-membership" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="membership.project.label" default="Project" /></th>
				...
				<g:each in="${membershipInstanceList}" status="i" var="membershipInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${membershipInstance.id}">${fieldValue(bean: membershipInstance, field: "project")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${membershipInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
