	...
	<body>
		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
				...
				<g:if test="${projectInstance?.memberships}">
				<li class="fieldcontain">
					<span id="memberships-label" class="property-label"><g:message code="project.memberships.label" default="Memberships" /></span>
				...
				<g:if test="${projectInstance?.userhistories}">
				<li class="fieldcontain">
					<span id="userhistories-label" class="property-label"><g:message code="project.userhistories.label" default="Userhistories" /></span>
					
						<g:each in="${projectInstance.userhistories}" var="u">
						<span class="property-value" aria-labelledby="userhistories-label"><g:link controller="userHistory" action="show" id="${u.id}">${u?.encodeAsHTML()}</g:link></span>
						</g:each>
