	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.velocity}">
				<li class="fieldcontain">
					<span id="velocity-label" class="property-label"><g:message code="user.velocity.label" default="Velocity" /></span>
					
						<span class="property-value" aria-labelledby="velocity-label"><g:fieldValue bean="${userInstance}" field="velocity"/></span>
